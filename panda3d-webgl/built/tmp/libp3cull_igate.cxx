 ...
 * built/tmp/interrogate/interrogate/interrogate -srcdir panda/src/cull -Ipanda/src/cull -DCPPPARSER -D__STDC__=1 -D__cplusplus=201103L -D__attribute__(x)= -D__i386__ -D__EMSCRIPTEN__ -DNDEBUG -oc built/tmp/libp3cull_igate.cxx -od built/pandac/input/libp3cull.in -fnames -string -refcount -assert -python-native -Sbuilt/include/parser-inc -Ipanda/src/cull -Sbuilt/tmp -Sbuilt/include -DLINK_ALL_STATIC= -module panda3d.core -library libp3cull binCullHandler.h config_cull.h cullBinBackToFront.h cullBinFixed.h cullBinFrontToBack.h cullBinStateSorted.h cullBinUnsorted.h drawCullHandler.h p3cull_composite1.cxx p3cull_composite2.cxx
 *
 */
...
#line 1354 "/workspaces/Ursina-on-Web/panda3d-webgl/built/tmp/libp3cull_igate.cxx"
#include "dtoolbase.h"
...
extern const struct LibraryDef libp3cull_moddef = {python_simple_funcs, exports, nullptr, &_in_module_def};
