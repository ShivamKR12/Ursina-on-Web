...
#if PY_MAJOR_VERSION >= 3
extern "C" EXPORT_INIT_FUNC PyObject *PyInit_core();
#else
extern "C" EXPORT_INIT_FUNC void initcore();
#endif
...
PyObject *PyInit_core() {
  ...
  const LibraryDef *defs[] = {&libp3dtoolbase_moddef, &libp3dtoolutil_moddef, &libp3express_moddef, &libp3pipeline_moddef, &libp3pnmtext_moddef, &libp3prc_moddef, &libp3pstatclient_moddef, &libp3putil_moddef, &libp3downloader_moddef, &libp3event_moddef, &libp3gobj_moddef, &libp3gsgbase_moddef, &libp3linmath_moddef, &libp3mathutil_moddef, &libp3movies_moddef, &libp3pgraph_moddef, &libp3pgraphnodes_moddef, &libp3pnmimage_moddef, &libp3text_moddef, &libp3audio_moddef, &libp3chan_moddef, &libp3char_moddef, &libp3collide_moddef, &libp3dgraph_moddef, &libp3grutil_moddef, &libp3parametrics_moddef, &libp3recorder_moddef, &libp3tform_moddef, &libp3device_moddef, &libp3display_moddef, &libp3pgui_moddef, nullptr};

  PyObject *module = Dtool_PyModuleInitHelper(defs, &py_core_module);
  if (module != nullptr) {
    pyenv_init();
    Dtool_libp3dtoolbase_BuildInstants(module);
    Dtool_libp3dtoolutil_BuildInstants(module);
    Dtool_libp3express_BuildInstants(module);
    Dtool_libp3pipeline_BuildInstants(module);
    Dtool_libp3pnmtext_BuildInstants(module);
    Dtool_libp3prc_BuildInstants(module);
