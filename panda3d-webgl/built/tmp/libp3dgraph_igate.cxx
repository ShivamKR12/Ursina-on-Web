 ...
 * built/tmp/interrogate/interrogate/interrogate -srcdir panda/src/dgraph -Ipanda/src/dgraph -DCPPPARSER -D__STDC__=1 -D__cplusplus=201103L -D__attribute__(x)= -D__i386__ -D__EMSCRIPTEN__ -DNDEBUG -oc built/tmp/libp3dgraph_igate.cxx -od built/pandac/input/libp3dgraph.in -fnames -string -refcount -assert -python-native -Sbuilt/include/parser-inc -Ipanda/src/dgraph -Sbuilt/tmp -Sbuilt/include -DLINK_ALL_STATIC= -module panda3d.core -library libp3dgraph config_dgraph.h dataGraphTraverser.h dataNode.h dataNodeTransmit.h p3dgraph_composite1.cxx p3dgraph_composite2.cxx
 *
 */
...
#line 1354 "/workspaces/Ursina-on-Web/panda3d-webgl/built/tmp/libp3dgraph_igate.cxx"
#include "dtoolbase.h"
...
#define Dtool_Ptr_ReferenceCount (imports[2].type)
  {"Thread", nullptr},
#define Dtool_Ptr_Thread (imports[3].type)
  {"TypeHandle", nullptr},
...
#define Dtool_Ptr_TypedWritableReferenceCount (imports[7].type)
  {"std::ostream", nullptr},
#define Dtool_Ptr_std_ostream (imports[8].type)
  {nullptr, nullptr},
};
#endif
...
static void *Dtool_UpcastInterface_DataGraphTraverser(PyObject *self, Dtool_PyTypedObject *requested_type) {
  ...
  if (type != &Dtool_DataGraphTraverser) {
    printf("%s ** Bad Source Type-- Requesting Conversion from %s to %s\n", "DataGraphTraverser", Py_TYPE(self)->tp_name, requested_type->_PyType.tp_name); fflush(nullptr);
    return nullptr;
  }
...
static PyObject *Dtool_Wrap_DataGraphTraverser(void *from_this, PyTypeObject *from_type) {
  DataGraphTraverser *to_this;
  if (from_type == nullptr || from_type == &Dtool_DataGraphTraverser._PyType) {
    to_this = (DataGraphTraverser *)from_this;
  }
  else {
    return nullptr;
  }
  // Allocate a new Python instance
  Dtool_PyInstDef *self = (Dtool_PyInstDef *)PyType_GenericAlloc(&Dtool_DataGraphTraverser._PyType, 0);
  self->_signature = PY_PANDA_SIGNATURE;
  self->_My_Type = &Dtool_DataGraphTraverser;
...
/**
 * Proxy class for DataNode
 */
class DtoolProxy_DataNode final : public DataNode, public DtoolProxy {
public:
  DtoolProxy_DataNode(std::string const &param0) : DataNode(param0) {}
...
static PyObject *Dtool_WrapProxy_DataNode(void *from_this, PyTypeObject *from_type) {
  DtoolProxy_DataNode *to_this;
  if (from_type == nullptr || from_type == &Dtool_DataNode._PyType) {
    to_this = (DtoolProxy_DataNode *)(DataNode*)from_this;
  }
  else if (from_type == (PyTypeObject *)Dtool_Ptr_Namable) {
    Namable *other_this = (Namable *)from_this;
    to_this = (DtoolProxy_DataNode *)(DataNode *)other_this;
  }
  ...
  bool nonzero = to_this->DataNode::unref();
...
static int Dtool_Init_DataNode(PyObject *self, PyObject *args, PyObject *kwds) {
  ...
  if (Dtool_ExtractArg(&arg, args, kwds, "name")) {
    ...
    if (param0_str != nullptr) {
      DataNode *return_value;
      if (Py_TYPE(self) != &Dtool_DataNode._PyType) {
        DtoolProxy_DataNode *proxy = new DtoolProxy_DataNode(std::string(param0_str, param0_len));
        DtoolProxy_Init(proxy, self, Dtool_DataNode, &Dtool_WrapProxy_DataNode);
        return_value = proxy;
      } else {
        return_value = new DataNode(std::string(param0_str, param0_len));
      }
      if (return_value == nullptr) {
        PyErr_NoMemory();
        return -1;
...
static void *Dtool_UpcastInterface_DataNode(PyObject *self, Dtool_PyTypedObject *requested_type) {
  ...
  if (type != &Dtool_DataNode) {
    printf("%s ** Bad Source Type-- Requesting Conversion from %s to %s\n", "DataNode", Py_TYPE(self)->tp_name, requested_type->_PyType.tp_name); fflush(nullptr);
    return nullptr;
  }
...
static PyObject *Dtool_Wrap_DataNode(void *from_this, PyTypeObject *from_type) {
  DataNode *to_this;
  if (from_type == nullptr || from_type == &Dtool_DataNode._PyType) {
    to_this = (DataNode *)from_this;
  }
  else if (from_type == (PyTypeObject *)Dtool_Ptr_Namable) {
    Namable *other_this = (Namable *)from_this;
    to_this = (DataNode *)other_this;
  }
  else if (from_type == (PyTypeObject *)Dtool_Ptr_PandaNode) {
    PandaNode *other_this = (PandaNode *)from_this;
    to_this = (DataNode *)other_this;
  ...
  // Allocate a new Python instance
  Dtool_PyInstDef *self = (Dtool_PyInstDef *)PyType_GenericAlloc(&Dtool_DataNode._PyType, 0);
  self->_signature = PY_PANDA_SIGNATURE;
  self->_My_Type = &Dtool_DataNode;
  self->_ptr_to_object = to_this;
  self->_memory_rules = false;
  self->_is_const = false;
  return (PyObject *)self;
...
static void Dtool_PyModuleClassInit_DataGraphTraverser(PyObject *module) {
  ...
  if (!initdone) {
    ...
    if (PyType_Ready((PyTypeObject *)&Dtool_DataGraphTraverser) < 0) {
      PyErr_Print();
      PyErr_Format(PyExc_TypeError, "PyType_Ready(%s)", "DataGraphTraverser");
      return;
    }
...
static int Dtool_Traverse_DataNode(PyObject *self, visitproc visit, void *arg) {
...
static int Dtool_Clear_DataNode(PyObject *self) {
  if (Py_TYPE(self) != &Dtool_DataNode._PyType && DtoolInstance_TYPE(self) == &Dtool_DataNode) {
    DtoolProxy_DataNode *proxy = (DtoolProxy_DataNode *)DtoolInstance_VOID_PTR(self);
...
struct Dtool_PyTypedObject Dtool_DataNode = {
  {
    ...
    " */",
#endif
    &Dtool_Traverse_DataNode,
    &Dtool_Clear_DataNode,
    nullptr, // tp_richcompare
    0, // tp_weaklistoffset
    nullptr,
    nullptr,
...
static void Dtool_PyModuleClassInit_DataNode(PyObject *module) {
  ...
  if (!initdone) {
    ...
    if (PyType_Ready((PyTypeObject *)&Dtool_DataNode) < 0) {
      PyErr_Print();
      PyErr_Format(PyExc_TypeError, "PyType_Ready(%s)", "DataNode");
      return;
    }
...
void Dtool_libp3dgraph_RegisterTypes() {
  ...
  nassertv(registry != nullptr);
  {
    ...
    registry->record_python_type(handle, &Dtool_DataNode._PyType, Dtool_Wrap_DataNode);
  }
}
...
extern const struct LibraryDef libp3dgraph_moddef = {python_simple_funcs, exports, nullptr, &_in_module_def};
#else
extern const struct LibraryDef libp3dgraph_moddef = {python_simple_funcs, exports, imports, &_in_module_def};
#endif
