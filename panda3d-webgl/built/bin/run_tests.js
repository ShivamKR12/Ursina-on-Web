...
// include: dtool/src/dtoolutil/console_preamble.js
/**
 * PANDA 3D SOFTWARE
...
// end include: dtool/src/dtoolutil/console_preamble.js
var arguments_ = [];
...
function findWasmBinary() {
  return locateFile("run_tests.wasm");
}
...
var ASM_CONSTS = {
  ...
  4673910: $0 => window._htmlVideoData[$0].video.duration,
  4673963: $0 => window._htmlVideoData[$0].video.videoWidth,
  4674018: $0 => window._htmlVideoData[$0].video.videoHeight,
  4674074: $0 => {
  ...
  4674343: $0 => window._htmlVideoData[$0].video.currentTime,
  4674399: ($0, $1) => {
    window._htmlVideoData[$0].video.loop = $1;
  },
  4674446: $0 => window._htmlVideoData[$0].video.loop,
  4674495: ($0, $1) => {
    window._htmlVideoData[$0].video.playbackRate = $1;
  },
  4674550: $0 => window._htmlVideoData[$0].video.playbackRate,
  4674607: $0 => !window._htmlVideoData[$0].video.paused,
  4674659: $0 => window._htmlVideoData[$0].video.muted,
  4674709: ($0, $1) => {
    window._htmlVideoData[$0].video.muted = ($1 !== 0);
  },
  4674765: $0 => window._htmlVideoData[$0].video.volume,
  4674816: ($0, $1) => {
  ...
  4675862: () => "requestVideoFrameCallback" in HTMLVideoElement.prototype,
  4675932: () => {
  ...
  4676269: $0 => window._httpChannels[$0].readyState,
  4676312: ($0, $1, $2) => {
    var xhr = window._httpChannels[$0];
  ...
  4678538: ($0, $1, $2) => {
    ...
    while (read < body.length) {
      ...
      for (var dest = $2; dest < $2 + size; ++dest) {
        HEAP8[(dest >> 0)] = body.charCodeAt(read++) & 255;
      }
      __write_stream($1, $2, size);
    }
    return read;
  ...
  4679587: () => (typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string"),
  4679709: $0 => {
...
function query_preload(path, width, height) {
...
var __video_frame_callback = Module["__video_frame_callback"] = makeInvalidEarlyAccess("__video_frame_callback");

var __extend_string = Module["__extend_string"] = makeInvalidEarlyAccess("__extend_string");

var __write_stream = Module["__write_stream"] = makeInvalidEarlyAccess("__write_stream");

var __http_channel_run = Module["__http_channel_run"] = makeInvalidEarlyAccess("__http_channel_run");

var __set_env_var = Module["__set_env_var"] = makeInvalidEarlyAccess("__set_env_var");

var __set_binary_name = Module["__set_binary_name"] = makeInvalidEarlyAccess("__set_binary_name");
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports["_video_frame_callback"] != "undefined", "missing Wasm export: _video_frame_callback");
  assert(typeof wasmExports["_extend_string"] != "undefined", "missing Wasm export: _extend_string");
  assert(typeof wasmExports["_write_stream"] != "undefined", "missing Wasm export: _write_stream");
  assert(typeof wasmExports["_http_channel_run"] != "undefined", "missing Wasm export: _http_channel_run");
  assert(typeof wasmExports["_set_env_var"] != "undefined", "missing Wasm export: _set_env_var");
  assert(typeof wasmExports["_set_binary_name"] != "undefined", "missing Wasm export: _set_binary_name");
  ...
  __video_frame_callback = Module["__video_frame_callback"] = createExportWrapper("_video_frame_callback", 4);
  __extend_string = Module["__extend_string"] = createExportWrapper("_extend_string", 2);
  __write_stream = Module["__write_stream"] = createExportWrapper("_write_stream", 3);
  __http_channel_run = Module["__http_channel_run"] = createExportWrapper("_http_channel_run", 1);
  __set_env_var = Module["__set_env_var"] = createExportWrapper("_set_env_var", 2);
  __set_binary_name = Module["__set_binary_name"] = createExportWrapper("_set_binary_name", 1);
