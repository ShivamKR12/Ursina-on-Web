...
build_time_vars = {
    ...
    'AR': '/workspaces/Ursina-on-Web/emsdk/upstream/emscripten/emar',
    'ARFLAGS': 'rcs',
    ...
    'BLDSHARED': '/workspaces/Ursina-on-Web/emsdk/upstream/emscripten/emcc',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.js',
    ...
    'BYTESTR_DEPS': '\\',
    'CC': '/workspaces/Ursina-on-Web/emsdk/upstream/emscripten/emcc',
    'CCSHARED': '-fPIC',
    ...
    'CONFIGURE_CPPFLAGS': '',
    'CONFIGURE_LDFLAGS': '',
    'CONFIGURE_LDFLAGS_NODIST': '-sALLOW_MEMORY_GROWTH -sTOTAL_MEMORY=20971520 -sWASM_BIGINT -sFORCE_FILESYSTEM -lidbfs.js -lnodefs.js -lproxyfs.js -lworkerfs.js',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'-C' '--host=wasm32-unknown-emscripten' '--build=x86_64-pc-linux-gnu' '--with-emscripten-target=browser' '--enable-wasm-dynamic-linking' '--with-build-python=/workspaces/Ursina-on-Web/Python-3.13.2/builddir/build/python' 'CONFIG_SITE=/workspaces/Ursina-on-Web/Python-3.13.2/Tools/wasm/config.site-wasm32-emscripten' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=wasm32-unknown-emscripten' 'PKG_CONFIG_PATH=' 'PKG_CONFIG_LIBDIR=/workspaces/Ursina-on-Web/emsdk/upstream/emscripten/cache/sysroot/local/lib/pkgconfig:/workspaces/Ursina-on-Web/emsdk/upstream/emscripten/cache/sysroot/lib/pkgconfig' 'CC=/workspaces/Ursina-on-Web/emsdk/upstream/emscripten/emcc'",
    'CONFINCLUDEDIR': '/usr/local/include',
    'CONFINCLUDEPY': '/usr/local/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/workspaces/Ursina-on-Web/Python-3.13.2/builddir/emscripten-browser/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/workspaces/Ursina-on-Web/Python-3.13.2/builddir/emscripten-browser/lcov-report',
    ...
    'CXX': '/workspaces/Ursina-on-Web/emsdk/upstream/emscripten/em++',
    ...
    'EXE': '.js',
    'EXEMODE': 755,
    'EXENAME': '/usr/local/bin/python3.13.js',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'FILEMODE': 644,
    'FREEZE_MODULE': '/workspaces/Ursina-on-Web/Python-3.13.2/builddir/build/python ../../Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': '/workspaces/Ursina-on-Web/Python-3.13.2/builddir/build/python ../../Programs/_freeze_module.py',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': '/workspaces/Ursina-on-Web/emsdk/upstream/emscripten/emcc',
    'LDFLAGS': '',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': '/workspaces/Ursina-on-Web/emsdk/upstream/emscripten/emcc',
    'LDVERSION': '3.13',
    'LIBC': '',
    ...
    'LIBMPDEC_CFLAGS': '-I../../Modules/_decimal/libmpdec -DCONFIG_32=1 -DANSI=1 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/usr/local/lib/pkgconfig',
    'LIBPL': '/usr/local/lib/python3.13/config-3.13-wasm32-emscripten',
    'LIBPYTHON': '',
    'LIBRARY': 'libpython3.13.a',
    'LIBRARY_DEPS': 'libpython3.13.a  ./usr/local/lib/python3.13/os.py python.html python.worker.js',
    'LIBRARY_OBJS': '\\',
    'LIBRARY_OBJS_OMIT_FROZEN': '\\',
    'LIBS': '-ldl  -lpthread',
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': '/workspaces/Ursina-on-Web/emsdk/upstream/emscripten/emcc',
    'LINKFORSHARED': '-sMAIN_MODULE --preload-file=./usr/local -O2 -g0',
    'LINK_PYTHON_DEPS': 'libpython3.13.a  ./usr/local/lib/python3.13/os.py python.html python.worker.js',
    'LINK_PYTHON_OBJS': '\\',
    'LIPO_32BIT_FLAGS': '',
    'LIPO_INTEL64_FLAGS': '',
    'LLVM_PROF_ERR': 'no',
    ...
    'LLVM_PROF_MERGER': '',
    'LN': 'ln',
    'LOCALMODLIBS': '-lm -lm -lm -lm -lm Modules/_decimal/libmpdec/libmpdec.a -sUSE_ZLIB -sUSE_BZIP2 -sUSE_ZLIB    Modules/_hacl/libHacl_Hash_SHA2.a   -lm Modules/expat/libexpat.a             -sUSE_SQLITE3',
    'MACHDEP': 'emscripten',
    'MACHDEP_OBJS': '',
    ...
    'MODULE_ZLIB_CFLAGS': '-sUSE_ZLIB',
    'MODULE_ZLIB_LDFLAGS': '-sUSE_ZLIB',
    ...
    'MODULE__BZ2_CFLAGS': '-sUSE_BZIP2',
    'MODULE__BZ2_LDFLAGS': '-sUSE_BZIP2',
    ...
    'MODULE__SQLITE3_CFLAGS': '-sUSE_SQLITE3 -I../../Modules/_sqlite',
    ...
    'MODULE__SQLITE3_LDFLAGS': '-sUSE_SQLITE3',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/workspaces/Ursina-on-Web/Python-3.13.2/builddir/emscripten-browser _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__emscripten_wasm32-emscripten _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /workspaces/Ursina-on-Web/Python-3.13.2/builddir/emscripten-browser/`cat pybuilddir.txt`) /workspaces/Ursina-on-Web/Python-3.13.2/builddir/build/python',
    'PYTHON_FOR_BUILD_DEPS': '',
    'PYTHON_FOR_FREEZE': '/workspaces/Ursina-on-Web/Python-3.13.2/builddir/build/python',
    'PYTHON_FOR_REGEN': '',
    'PYTHON_HEADERS': '\\',
    'PYTHON_OBJS': '\\',
    ...
    'PY_CORE_LDFLAGS': '-sALLOW_MEMORY_GROWTH -sTOTAL_MEMORY=20971520 -sWASM_BIGINT -sFORCE_FILESYSTEM -lidbfs.js -lnodefs.js -lproxyfs.js -lworkerfs.js',
    'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../../Include',
    'PY_ENABLE_SHARED': 0,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '',
    'PY_LDFLAGS_NODIST': '-sALLOW_MEMORY_GROWTH -sTOTAL_MEMORY=20971520 -sWASM_BIGINT -sFORCE_FILESYSTEM -lidbfs.js -lnodefs.js -lproxyfs.js -lworkerfs.js',
    'PY_LDFLAGS_NOLTO': '',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': '_PYTHON_PROJECT_BASE=/workspaces/Ursina-on-Web/Python-3.13.2/builddir/emscripten-browser _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__emscripten_wasm32-emscripten _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /workspaces/Ursina-on-Web/Python-3.13.2/builddir/emscripten-browser/`cat pybuilddir.txt`) /workspaces/Ursina-on-Web/Python-3.13.2/builddir/build/python',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': '_PYTHON_PROJECT_BASE=/workspaces/Ursina-on-Web/Python-3.13.2/builddir/emscripten-browser _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__emscripten_wasm32-emscripten _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /workspaces/Ursina-on-Web/Python-3.13.2/builddir/emscripten-browser/`cat pybuilddir.txt`) /workspaces/Ursina-on-Web/Python-3.13.2/builddir/build/python -m test',
    ...
    'abs_builddir': '/workspaces/Ursina-on-Web/Python-3.13.2/builddir/emscripten-browser',
    'abs_srcdir': '/workspaces/Ursina-on-Web/Python-3.13.2/builddir/emscripten-browser/../..',
